    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            ...
            if (response && response.data) {
                ...
                props.setDiscussions((discussions) => [newPost, ...(discussions || [])]);
        ...
        >
            ...
            <DialogContent>
                <TextField
                    ...
                    required
                    InputProps={{
                        endAdornment: postLoading ? <CircularProgress color="inherit" size={20} /> : null,
                    }}
                />
                <TextField
                ...
                <DialogActions  >
                    ...
                    <Button
                        ...
                        variant="contained"
                        size="small"
                        startIcon={postLoading ? <CircularProgress size={20} /> : <SendIcon />}
                        disabled={postLoading}
                    >
                        Post
                    </Button>
